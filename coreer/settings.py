...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'coreer.info@gmail.com'  # Replace with your Gmail email address
EMAIL_HOST_PASSWORD = 'iakgzbdvrkblieqz'  # Replace with your Gmail password or app-specific password
...
if IS_HEROKU_APP:
    DATABASES = {
        'default': dj_database_url.config(conn_max_age=0, conn_health_checks=True, ssl_require=True),
    }
else:
    DATABASES = {
        'default': {
